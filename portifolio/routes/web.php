...
Route::post('/search/service', [ServiceController::class, 'search'])->middleware(['auth', 'verified']);
...
Route::post('/search/portfolio', [PortfolioController::class, 'search'])->middleware(['auth', 'verified']);
